...
//        try {
//            preparedStatement = connection.prepareStatement("Delete from customer_addresses WHERE id = ?");
//            preparedStatement.setInt(1, id);
//            preparedStatement.executeUpdate();
//            System.out.printf("customerAddresses with id %d is deleted.%n");
//        } catch (Exception exception) {
//            exception.printStackTrace();
//        }
//    }
...
//        int idRecords = 0;
//        try {
//            preparedStatement = connection.prepareStatement("Select COUNT (id) from customer_addresses ");
//            resultSet = preparedStatement.executeQuery();
//            while (resultSet.next()) {
...
//    }
//
//    public List <CustomerAddresses> getByIdWithResultSetMapper(int id) {
...
//            e.printStackTrace();
//        }
//        List<CustomerAddresses> searchedCustomerAddress = resultSetMapper.mapResultSetToObject(resultSet, CustomerAddresses.class);
//        System.out.println("Searched customer address is:" + searchedCustomerAddress);
//        return searchedCustomerAddress;
//    }
//
//    public List<CustomerAddresses> getByIdsWithResultSetMapper(List<Integer> ids) {
//        ResultSetMapper resultSetMapper = new ResultSetMapper();
//        try {
//            preparedStatement = connection.prepareStatement
//                    (String.format("SELECT * FROM customer_addresses WHERE id IN (%s)",
